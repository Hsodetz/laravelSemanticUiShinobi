...
Route::middleware(['auth'])->group(function(){
    ...
    Route::destroy('roles/{role}', 'RoleController@destroy')->name('roles.destroy')
    ...
    Route::destroy('products/{role}', 'ProductController@destroy')->name('products.destroy')
    ...
    Route::destroy('users/{role}', 'UserController@destroy')->name('users.destroy')
